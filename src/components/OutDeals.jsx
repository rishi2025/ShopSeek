...
const OutDeals = ({
  ...
  return (
    <div className="max-h-[30rem] max-w-[17rem] mx-4 bg-gradient-to-b from-violet-300 to-violet-400 rounded-xl shadow-lg p-4">
      ...
      <p className="font-gruppo text-center text-xl font-bold mb-4">Price Offered : Rs. {price}</p>
      ...
      <div className="text-sm text-center mb-4">
        <p className='font-gruppo font-bold'>OFFERED ON: <span className="font-gruppo ">{offerDate}</span></p>
